...
* `AUTH_USERS` - Put your ID & other Sudo Users IDs. Separate with **Space**. Just for using [Admin Commands](https://github.com/suhaib8565/newhevc/tree/HEVC#admin-commands).
